...
(
    ...
    `D_ORIGIN_DATA` blob        NOT NULL COMMENT '图数据',
    `D_DEPLOY_DATA` blob COMMENT '部署数据',
    `D_PREVIOUS_ID` int unsigned          COMMENT '上一部署状态主键',
    `D_STATUS`      varchar(20) NOT NULL COMMENT '状态',
    `D_CURRENT`     tinyint(1)   NOT NULL COMMENT '当前状态',
    `F_ID`          varchar(50) NOT NULL COMMENT '流程主键',
    PRIMARY KEY (`D_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='流程图信息表';